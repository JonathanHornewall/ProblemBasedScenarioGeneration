...
const EXPERIMENT_ID = "resource_allocation/experiment_1_tiny"
const EXPERIMENT_NAME = "resource_allocation_experiment_1_tiny"
...
experiment_module_name() = :ResourceAllocationExperiment1Tiny
