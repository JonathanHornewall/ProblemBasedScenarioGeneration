...
function dataGeneration_in(Nsamples,ϕ,ζ,σ,J,p,L,Σ)
...
function dataGeneration_out(Noutofsamples,ϕ,ζ,σ,J,p,L,Σ)
    ...
    for j in 1:J
        ...
        for n in 1:Noutofsamples
            ...
            # we use the same x for all data for out of sample data
            Yoos[j,n] = oos_Yⱼ
        end
